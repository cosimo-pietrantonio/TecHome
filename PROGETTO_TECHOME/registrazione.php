            ...
            <div class="card-3">
                ...
                <div class="card-heading card-support">
                    <div class="wrapperM font-poppins">
                        <label><center>Benvenuto in Techome, siamo lieti di averti tra noi. Registrandoti, avrai la possibilità di ordinare tutto quello che vuoi, quando vuoi.
                               Ti basterà un click e al resto pensiamo noi. Se fai parte dello staff di Techome e ti occupi della gestione dei prodotti,
                               allora <a href="#reg-soci">clicca qui</a> per passare alla registrazione per soci.</center></label> 
                    </div>    
                </div> 
                ...
                <div class="card-body"> <!--contiene il form-->
                    ...
                    <form action="controlli_registrazione.php" method="POST">
                        ...
                        <div class="p-t-10">
                            <button id="sc" class="btn btn--smussato btn--color" type="submit">REGISTRATI</button>
                        </div>
            ...
            <div class="card-3">
                ...
                <div class="card-body">
                    ...
                    <form action="controlli_registrazione.php" method="POST">
                        ...
                        <div class="p-t-10">
                            <button id="so" class="btn btn--smussato btn--color" type="submit">REGISTRATI</button>
                        </div>
